 ...
 <div class="navbar navbar-fixed-top navbar-inverse">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="../">udienz.{my,web,biz}.id</a>
       <div class="nav-collapse collapse" id="main-menu">
        <ul class="nav" id="main-menu-left">
          <li><a href="#contact">Contact</a></li>
          <li><a id="swatch-link" href="http://log.udienz.web.id">Blog</a></li>
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Links <b class="caret"></b></a>
            <ul class="dropdown-menu" id="swatch-menu">
              <li><a href="../default">Default</a></li>
              <li class="divider"></li>
              <li><a href="https://www.indocenter.co.id">indoCENTER</a></li>
              <li><a href="http://www.rad.net.id/">RADNET</a></li>
              <li><a href="http://mirror.unej.ac.id">mirror UNEJ</a></li>
              <li><a href="http://buaya.klas.or.id">buaya KLAS</a></li>
            </ul>
          </li>
